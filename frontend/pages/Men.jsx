...
const Men = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      sizes: ['30', '32', '34', '36'],
      image: 'https://images.unsplash.com/photo-1594631252845-29fc4cc8cde9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 6,
  ...
  const filtersOptions = {
    category: ['T-Shirts', 'Shirts', 'Pants', 'Jackets', 'Shoes', 'Accessories'],
    color: ['Black', 'White', 'Blue', 'Gray', 'Navy', 'Khaki', 'Pink'],
    size: ['S', 'M', 'L', 'XL', '28', '30', '32', '34', '36', '8', '9', '10', '11', '12'],
    ...
    <div className="bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-baseline justify-between border-b border-gray-200 pt-8 pb-6">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Men's Clothing</h1>
