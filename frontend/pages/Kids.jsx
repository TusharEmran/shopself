...
const Kids = () => {
  ...
  const products = [
    {
      ...
      age: ['2-4', '5-7', '8-10'],
      sizes: ['2T', '3T', '4T', 'S', 'M'],
      image: 'https://images.unsplash.com/photo-1597356988506-2a6cb6a35a4e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 2,
      name: 'Denim Overalls',
      ...
      age: ['2-4', '5-7'],
      sizes: ['2T', '3T', '4T'],
      image: 'https://images.unsplash.com/photo-1604917018610-a0a7a5d1f201?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 3,
      name: 'Princess Dress',
      ...
      age: ['2-4', '5-7', '8-10'],
      sizes: ['2T', '3T', '4T', 'S', 'M'],
      image: 'https://images.unsplash.com/photo-1596704017250-6d190bd0f58c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 4,
    ...
    },
    {
      ...
      age: ['2-4', '5-7'],
      sizes: ['2T', '3T', '4T'],
      image: 'https://images.unsplash.com/photo-1583744946564-b52d01e2da64?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80'
    }
  ];
  ...
  const filtersOptions = {
    ...
    age: ['0-12m', '12-24m', '2-4', '5-7', '8-10', '11-13'],
    size: ['0-3m', '3-6m', '6-12m', '12-18m', '18-24m', '2T', '3T', '4T', 'XS', 'S', 'M', 'L', '10', '11', '12', '13', '1', '2', '3'],
    price: ['Under $20', '$20 to $40', '$40 to $60', 'Over $60']
  };
    ...
    <div className="bg-white">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-baseline justify-between border-b border-gray-200 pt-8 pb-6">
          <h1 className="text-4xl font-bold tracking-tight text-gray-900">Kids' Clothing</h1>
